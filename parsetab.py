...
_lr_productions = [
  ...
  ('program -> function','program',1,'p_program','150070001-150070018.py',220),
  ('program -> function program','program',2,'p_program','150070001-150070018.py',221),
  ('function -> TYPE NAME LPAREN RPAREN LBRACE fbody RBRACE','function',7,'p_function','150070001-150070018.py',245),
  ('fbody -> allstatement','fbody',1,'p_fbody','150070001-150070018.py',279),
  ('fbody -> allstatement fbody','fbody',2,'p_fbody','150070001-150070018.py',280),
  ('allstatement -> statement','allstatement',1,'p_allstatement_expr','150070001-150070018.py',297),
  ('allstatement -> unmatchedstatement','allstatement',1,'p_allstatement_expr','150070001-150070018.py',298),
  ('statement -> assignment','statement',1,'p_statement_expr','150070001-150070018.py',304),
  ('statement -> declaration','statement',1,'p_statement_expr','150070001-150070018.py',305),
  ('statement -> whileblock','statement',1,'p_statement_expr','150070001-150070018.py',306),
  ('statement -> ifblock','statement',1,'p_statement_expr','150070001-150070018.py',307),
  ('unmatchedstatement -> IF LPAREN conditional RPAREN allstatement','unmatchedstatement',5,'p_unmatchedstatement_expr1','150070001-150070018.py',313),
  ('unmatchedstatement -> IF LPAREN conditional RPAREN statement ELSE unmatchedstatement','unmatchedstatement',7,'p_unmatchedstatement_expr1','150070001-150070018.py',314),
  ('unmatchedstatement -> IF LPAREN conditional RPAREN LBRACE fbody RBRACE ELSE unmatchedstatement','unmatchedstatement',9,'p_unmatchedstatement_expr1','150070001-150070018.py',315),
  ('unmatchedstatement -> IF LPAREN conditional RPAREN LBRACE fbody RBRACE','unmatchedstatement',7,'p_unmatchedstatement_expr2','150070001-150070018.py',326),
  ('ifblock -> IF LPAREN conditional RPAREN statement ELSE statement','ifblock',7,'p_ifblock1','150070001-150070018.py',332),
  ('ifblock -> IF LPAREN conditional RPAREN statement ELSE LBRACE fbody RBRACE','ifblock',9,'p_ifblock1','150070001-150070018.py',333),
  ('ifblock -> IF LPAREN conditional RPAREN LBRACE fbody RBRACE ELSE LBRACE fbody RBRACE','ifblock',11,'p_ifblock1','150070001-150070018.py',334),
  ('ifblock -> IF LPAREN conditional RPAREN LBRACE fbody RBRACE ELSE statement','ifblock',9,'p_ifblock2','150070001-150070018.py',345),
  ('whileblock -> WHILE LPAREN conditional RPAREN LBRACE fbody RBRACE','whileblock',7,'p_while','150070001-150070018.py',350),
  ('conditional -> conditionbase','conditional',1,'p_conditional','150070001-150070018.py',356),
  ('conditional -> conditional LESSTHANEQ conditional','conditional',3,'p_conditional','150070001-150070018.py',357),
  ('conditional -> conditional GREATERTHANEQ conditional','conditional',3,'p_conditional','150070001-150070018.py',358),
  ('conditional -> conditional UNEQUAL conditional','conditional',3,'p_conditional','150070001-150070018.py',359),
  ('conditional -> conditional EQUALCHECK conditional','conditional',3,'p_conditional','150070001-150070018.py',360),
  ('conditional -> conditional LESSTHAN conditional','conditional',3,'p_conditional','150070001-150070018.py',361),
  ('conditional -> conditional GREATERTHAN conditional','conditional',3,'p_conditional','150070001-150070018.py',362),
  ('conditional -> conditional ANDOPERATOR conditional','conditional',3,'p_conditional','150070001-150070018.py',363),
  ('conditional -> conditional OROPERATOR conditional','conditional',3,'p_conditional','150070001-150070018.py',364),
  ('conditionbase -> CS LESSTHANEQ CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',388),
  ('conditionbase -> CS GREATERTHANEQ CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',389),
  ('conditionbase -> CS UNEQUAL CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',390),
  ('conditionbase -> CS EQUALCHECK CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',391),
  ('conditionbase -> CS LESSTHAN CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',392),
  ('conditionbase -> CS GREATERTHAN CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',393),
  ('CS -> expression','CS',1,'p_cs','150070001-150070018.py',413),
  ('CS -> NOT LPAREN expression RPAREN','CS',4,'p_cs','150070001-150070018.py',414),
  ('declaration -> TYPE dlist1 SEMICOLON','declaration',3,'p_declaration1','150070001-150070018.py',422),
  ('dlist1 -> NAME','dlist1',1,'p_dlistname','150070001-150070018.py',428),
  ('dlist1 -> NAME COMMA dlist1','dlist1',3,'p_dlistname','150070001-150070018.py',429),
  ('dlist1 -> specialvar','dlist1',1,'p_dlistpointer','150070001-150070018.py',436),
  ('dlist1 -> specialvar COMMA dlist1','dlist1',3,'p_dlistpointer','150070001-150070018.py',437),
  ('specialvar -> TIMES specialvar','specialvar',2,'p_specialvar','150070001-150070018.py',444),
  ('specialvar -> TIMES NAME','specialvar',2,'p_specialvar','150070001-150070018.py',445),
  ('assignment -> assignment_base SEMICOLON','assignment',2,'p_assignment','150070001-150070018.py',450),
  ('assignment_base -> TIMES pointervar EQUALS expression','assignment_base',4,'p_assignment_base_pointer','150070001-150070018.py',459),
  ('assignment_base -> NAME EQUALS expression','assignment_base',3,'p_assignment_base_pointer','150070001-150070018.py',460),
  ('expression -> expression PLUS expression','expression',3,'p_expression1','150070001-150070018.py',480),
  ('expression -> expression MINUS expression','expression',3,'p_expression1','150070001-150070018.py',481),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression1','150070001-150070018.py',482),
  ('expression -> expression TIMES expression','expression',3,'p_expression_mul','150070001-150070018.py',499),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','150070001-150070018.py',507),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_paren','150070001-150070018.py',514),
  ('expression -> NUMBER','expression',1,'p_expression_base_number','150070001-150070018.py',520),
  ('expression -> pointervar','expression',1,'p_expression_base_pointer','150070001-150070018.py',526),
  ('pointervar -> TIMES pointervar','pointervar',2,'p_pointervar1','150070001-150070018.py',533),
  ('pointervar -> ADDROF pointervar','pointervar',2,'p_pointervar2','150070001-150070018.py',539),
  ('pointervar -> NAME','pointervar',1,'p_pointervar3','150070001-150070018.py',546),
]
