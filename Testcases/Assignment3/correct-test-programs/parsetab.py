...
_lr_productions = [
  ...
  ('program -> function','program',1,'p_program','150070001-150070018.py',364),
  ('program -> function program','program',2,'p_program','150070001-150070018.py',365),
  ('function -> TYPE NAME LPAREN RPAREN LBRACE fbody RBRACE','function',7,'p_function','150070001-150070018.py',389),
  ('fbody -> allstatement','fbody',1,'p_fbody','150070001-150070018.py',426),
  ('fbody -> allstatement fbody','fbody',2,'p_fbody','150070001-150070018.py',427),
  ('allstatement -> statement','allstatement',1,'p_allstatement_expr','150070001-150070018.py',444),
  ('allstatement -> unmatchedstatement','allstatement',1,'p_allstatement_expr','150070001-150070018.py',445),
  ('statement -> assignment','statement',1,'p_statement_expr','150070001-150070018.py',451),
  ('statement -> declaration','statement',1,'p_statement_expr','150070001-150070018.py',452),
  ('statement -> whileblock','statement',1,'p_statement_expr','150070001-150070018.py',453),
  ('statement -> ifblock','statement',1,'p_statement_expr','150070001-150070018.py',454),
  ('unmatchedstatement -> IF LPAREN conditional RPAREN allstatement','unmatchedstatement',5,'p_unmatchedstatement_expr1','150070001-150070018.py',460),
  ('unmatchedstatement -> IF LPAREN conditional RPAREN statement ELSE unmatchedstatement','unmatchedstatement',7,'p_unmatchedstatement_expr1','150070001-150070018.py',461),
  ('unmatchedstatement -> IF LPAREN conditional RPAREN LBRACE fbody RBRACE ELSE unmatchedstatement','unmatchedstatement',9,'p_unmatchedstatement_expr1','150070001-150070018.py',462),
  ('unmatchedstatement -> IF LPAREN conditional RPAREN LBRACE fbody RBRACE','unmatchedstatement',7,'p_unmatchedstatement_expr2','150070001-150070018.py',473),
  ('ifblock -> IF LPAREN conditional RPAREN statement ELSE statement','ifblock',7,'p_ifblock1','150070001-150070018.py',479),
  ('ifblock -> IF LPAREN conditional RPAREN statement ELSE LBRACE fbody RBRACE','ifblock',9,'p_ifblock1','150070001-150070018.py',480),
  ('ifblock -> IF LPAREN conditional RPAREN LBRACE fbody RBRACE ELSE LBRACE fbody RBRACE','ifblock',11,'p_ifblock1','150070001-150070018.py',481),
  ('ifblock -> IF LPAREN conditional RPAREN LBRACE fbody RBRACE ELSE statement','ifblock',9,'p_ifblock2','150070001-150070018.py',492),
  ('whileblock -> WHILE LPAREN conditional RPAREN LBRACE fbody RBRACE','whileblock',7,'p_while','150070001-150070018.py',497),
  ('conditional -> conditionbase','conditional',1,'p_conditional','150070001-150070018.py',503),
  ('conditional -> conditional LESSTHANEQ conditional','conditional',3,'p_conditional','150070001-150070018.py',504),
  ('conditional -> conditional GREATERTHANEQ conditional','conditional',3,'p_conditional','150070001-150070018.py',505),
  ('conditional -> conditional UNEQUAL conditional','conditional',3,'p_conditional','150070001-150070018.py',506),
  ('conditional -> conditional EQUALCHECK conditional','conditional',3,'p_conditional','150070001-150070018.py',507),
  ('conditional -> conditional LESSTHAN conditional','conditional',3,'p_conditional','150070001-150070018.py',508),
  ('conditional -> conditional GREATERTHAN conditional','conditional',3,'p_conditional','150070001-150070018.py',509),
  ('conditional -> conditional ANDOPERATOR conditional','conditional',3,'p_conditional','150070001-150070018.py',510),
  ('conditional -> conditional OROPERATOR conditional','conditional',3,'p_conditional','150070001-150070018.py',511),
  ('conditionbase -> CS LESSTHANEQ CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',535),
  ('conditionbase -> CS GREATERTHANEQ CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',536),
  ('conditionbase -> CS UNEQUAL CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',537),
  ('conditionbase -> CS EQUALCHECK CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',538),
  ('conditionbase -> CS LESSTHAN CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',539),
  ('conditionbase -> CS GREATERTHAN CS','conditionbase',3,'p_conditionbase','150070001-150070018.py',540),
  ('CS -> expression','CS',1,'p_cs','150070001-150070018.py',560),
  ('CS -> NOT LPAREN expression RPAREN','CS',4,'p_cs','150070001-150070018.py',561),
  ('declaration -> TYPE dlist1 SEMICOLON','declaration',3,'p_declaration1','150070001-150070018.py',569),
  ('dlist1 -> NAME','dlist1',1,'p_dlistname','150070001-150070018.py',575),
  ('dlist1 -> NAME COMMA dlist1','dlist1',3,'p_dlistname','150070001-150070018.py',576),
  ('dlist1 -> specialvar','dlist1',1,'p_dlistpointer','150070001-150070018.py',583),
  ('dlist1 -> specialvar COMMA dlist1','dlist1',3,'p_dlistpointer','150070001-150070018.py',584),
  ('specialvar -> TIMES specialvar','specialvar',2,'p_specialvar','150070001-150070018.py',591),
  ('specialvar -> TIMES NAME','specialvar',2,'p_specialvar','150070001-150070018.py',592),
  ('assignment -> assignment_base SEMICOLON','assignment',2,'p_assignment','150070001-150070018.py',597),
  ('assignment_base -> TIMES pointervar EQUALS expression','assignment_base',4,'p_assignment_base_pointer','150070001-150070018.py',606),
  ('assignment_base -> NAME EQUALS expression','assignment_base',3,'p_assignment_base_pointer','150070001-150070018.py',607),
  ('expression -> expression PLUS expression','expression',3,'p_expression1','150070001-150070018.py',627),
  ('expression -> expression MINUS expression','expression',3,'p_expression1','150070001-150070018.py',628),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression1','150070001-150070018.py',629),
  ('expression -> expression TIMES expression','expression',3,'p_expression_mul','150070001-150070018.py',646),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','150070001-150070018.py',654),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_paren','150070001-150070018.py',661),
  ('expression -> NUMBER','expression',1,'p_expression_base_number','150070001-150070018.py',667),
  ('expression -> pointervar','expression',1,'p_expression_base_pointer','150070001-150070018.py',673),
  ('pointervar -> TIMES pointervar','pointervar',2,'p_pointervar1','150070001-150070018.py',680),
  ('pointervar -> ADDROF pointervar','pointervar',2,'p_pointervar2','150070001-150070018.py',686),
  ('pointervar -> NAME','pointervar',1,'p_pointervar3','150070001-150070018.py',693),
]
